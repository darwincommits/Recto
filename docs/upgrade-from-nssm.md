...
This reads NSSM's current AppPath / AppParameters / AppDirectory /
...
- Retarget NSSM `AppPath` to `python.exe` and `AppParameters` to
...
that would change (AppPath, AppParameters, AppDirectory,
